      ...
      <View style={styles.fullHeight}>
        ...
        {this.state.type == 'anonymous' && (
          <Text style={styles.para}>
            You are logged in but you are still anonymous. If you wish to
            connect this account with your email, signup now !{' '}
          </Text>
        )}
        {this.state.type == 'credential' && (
          <Text style={styles.para}>
            You are logged in with credentials. Your anonymous account is now
            linked with these credentials. You are no longer anonymous !{' '}
          </Text>
        )}
